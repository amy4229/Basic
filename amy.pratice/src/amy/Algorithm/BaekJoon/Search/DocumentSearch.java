...
public class DocumentSearch {
	public int solution(String docu, String kwd) {
		int cnt = 0;
		Pattern p = Pattern.compile(kwd);
		Matcher m = p.matcher(docu);
	...
	public static void main(String[] args) throws NumberFormatException, IOException, ScriptException {
		...
		String kwd  =br.readLine();
		DocumentSearch ds = new DocumentSearch();
		System.out.println(ds.solution(docu, kwd));
		br.close();
